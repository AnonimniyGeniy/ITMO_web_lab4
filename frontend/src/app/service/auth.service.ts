...
export class AuthService {
  ...
  private loginUrl = 'http://localhost:8080/lab4_web-1.0-SNAPSHOT/api/auth/login';
  private signupUrl = 'http://localhost:8080/lab4_web-1.0-SNAPSHOT/api/auth/register';
