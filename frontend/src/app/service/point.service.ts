...
export class PointService {
  ...
  private getUrl = 'http://localhost:8080/lab4_web-1.0-SNAPSHOT/api/hits';
  private saveUrl = 'http://localhost:8080/lab4_web-1.0-SNAPSHOT/api/hits/save';
  private clearUrl = 'http://localhost:8080/lab4_web-1.0-SNAPSHOT/api/hits/clear';
